...
# It was introduced by Andrew B. Godbehere, Akihiro Matsukawa, Ken Goldberg 
# in their paper "Visual Tracking of Human Visitors under Variable-Lighting Conditions for a Responsive Audio Art Installation" 
# in 2012.
...
while True:
    ...
    frameDelta = cv2.morphologyEx(frameDelta, cv2.MORPH_OPEN, kernel)
